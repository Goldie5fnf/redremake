...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'examination':
				dialogue = CoolUtil.coolTextFile(Paths.txt('examination/examinationDialogue'));
			case 'summing-up':
				dialogue = CoolUtil.coolTextFile(Paths.txt('summing-up/summing-upDialogue'));
			case 'the-real-deal':
				dialogue = CoolUtil.coolTextFile(Paths.txt('the-real-deal/the-real-dealDialogue'));
		}
		...
		case 'red': 
			{
				curStage = 'red';
					eyes = new FlxSprite(-200, -100);
					eyes.frames = Paths.getSparrowAtlas('bgeyes','red');
