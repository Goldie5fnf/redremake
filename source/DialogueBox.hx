...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		portraitLeft.frames = Paths.getSparrowAtlas('weeb/redportrait');
		portraitLeft.animation.addByPrefix('enter', 'Red Portrait Enter', 24, false);
		...
		portraitRight.frames = Paths.getSparrowAtlas('weeb/bfPortraithd');
		portraitRight.animation.addByPrefix('enter', 'bf Portrait Enter hd', 24, false);
